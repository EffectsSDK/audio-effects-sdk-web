...
export interface EnhancementOptions {
  ...
  // Voice changer (makes voice unrecognizable)
  enableVoiceChanger?: boolean;
  voiceChangerIntensity?: number;    // 0-100, convenience method (sets all params)
  voiceChangerPitch?: number;        // -12 to +12 semitones
  voiceChangerFormant?: number;      // -100 to +100 (spectral tilt)
  voiceChangerChorus?: number;       // 0 to 100 (modulation depth)
}
